...
[<img src="https://img.shields.io/github/license/cxjava/pingtunnel">](https://github.com/cxjava/pingtunnel)
[<img src="https://img.shields.io/github/languages/top/cxjava/pingtunnel">](https://github.com/cxjava/pingtunnel)
[![Go Report Card](https://goreportcard.com/badge/github.com/cxjava/pingtunnel)](https://goreportcard.com/report/github.com/cxjava/pingtunnel)
[<img src="https://img.shields.io/github/v/release/cxjava/pingtunnel">](https://github.com/cxjava/pingtunnel/releases)
[<img src="https://img.shields.io/github/downloads/cxjava/pingtunnel/total">](https://github.com/cxjava/pingtunnel/releases)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/a200bca59d1b4ca7a9c2cdb564508b47)](https://www.codacy.com/manual/cxjava/pingtunnel?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=cxjava/pingtunnel&amp;utm_campaign=Badge_Grade)
...
* 从[releases](https://github.com/cxjava/pingtunnel/releases)下载对应的安装包，如pingtunnel_linux64.zip，然后解压，以**root**权限执行
```
...
```shell
#安装到当前目录的./bin下
sudo wget -O - https://cdn.jsdelivr.net/gh/cxjava/pingtunnel/install.sh | sh
#安装到/usr/local/bin
sudo wget -O - https://cdn.jsdelivr.net/gh/cxjava/pingtunnel/install.sh | sh -s -- -b /usr/local/bin
```
* (可选)关闭系统默认的ping
```
...
# 下载
cmd: https://github.com/cxjava/pingtunnel/releases

QT GUI: https://github.com/esrrhs/pingtunnel-qt

# Stargazers over time

[![Stargazers over time](https://starchart.cc/cxjava/pingtunnel.svg)](https://starchart.cc/cxjava/pingtunnel)
